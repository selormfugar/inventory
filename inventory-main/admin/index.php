                    ...
                    <div id="invoice-product-rows">
                        <div class="row mb-3 product-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control quantity" name="interest" step="any" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Unit Price</label>
                                <input type="number" step="0.01" class="form-control price" name="prices[]" readonly>
...
<script>
   document.addEventListener("DOMContentLoaded", function () {
    const productRowsContainer = document.getElementById("invoice-product-rows");
    const interestInput = document.querySelector("input[name='interest']");
    const totalAmountInput = document.getElementById("invoice-total-amount");
    ...
    // Update total when product quantity or interest changes
    productRowsContainer.addEventListener("input", updateTotalAmount);
    
    // Add event listener for the interest input field
    interestInput.addEventListener("input", updateTotalAmount);
});
