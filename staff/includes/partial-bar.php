          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="charts">
                <ul class="nav flex-column sub-menu">
                  <!-- <li class="nav-item"> <a class="nav-link" href="pages/charts/chartjs.html">Bills</a></li> -->
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                ...
                <li class="nav-item"> <a class="nav-link" href="./suppliers.php">Suppliers</a></li>
                  ...
                  <!-- <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-table.html">Suppliers</a></li> -->
                </ul>
              </div>
            </li>
            <li class="nav-item">
